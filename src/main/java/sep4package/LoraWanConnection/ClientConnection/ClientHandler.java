  ...
  @Override public void run()
  {
    while (true) {
      try {
        ...
        Sensors incomingSensorData = gson.fromJson(dataFromServer, Sensors.class);
        String integerAsHexString = Integer.toHexString(incomingSensorData.getCO2().getCO2Level());
